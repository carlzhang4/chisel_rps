...
#set_property PACKAGE_PIN AV42 [get_ports cmac_pin2_gt_clk_p]
#set_property PACKAGE_PIN AR40 [get_ports cmac_pin3_gt_clk_p]
 ...
 add_cells_to_pblock pblock_roce [get_cells [list roce2/roce]]
 add_cells_to_pblock pblock_roce [get_cells [list roce3/roce]]


 create_pblock pblock_1
 resize_pblock [get_pblocks pblock_1] -add {SLR1}

 add_cells_to_pblock pblock_1 [get_cells [list roce3/ip]]

 create_pblock pblock_cmac
 resize_pblock pblock_cmac -add SLR2:SLR2
 add_cells_to_pblock pblock_cmac [get_cells [list roce/cmac]]
 add_cells_to_pblock pblock_cmac [get_cells [list roce1/cmac]]
 add_cells_to_pblock pblock_cmac [get_cells [list roce2/cmac]]
 add_cells_to_pblock pblock_1 [get_cells [list roce3/cmac]]
 add_cells_to_pblock pblock_cmac [get_cells [list roce/ip]]
 add_cells_to_pblock pblock_cmac [get_cells [list roce1/ip]]
 add_cells_to_pblock pblock_cmac [get_cells [list roce2/ip]]